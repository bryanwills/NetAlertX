...
| Plugin dev | `plugin-development` | `plugin-run-development` | Both cover data contract, phases, formats, the `RUN_TIMEOUT` kill-timer gotcha, and a pre-PR pointer to the Conventions Checklist in `docs/PLUGINS_DEV.md`; kept in sync manually |
